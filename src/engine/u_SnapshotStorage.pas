...
type
  ...
  private
    fBuffer: Pointer;
    fFreeCount: Integer;
    fFreeList: array[0 .. SNAPSHOTS_PER_BLOCK - 1] of Integer;
  public
    constructor Create;
  ...
  private
    ...
    fPartialBlocks: TList<TBlock>;   // blocks with at least 1 opening
...
begin
  Inc(fFreeCount);
  fFreeList[fFreeCount - 1] := aUnitIndex;
end;
...
begin
  ...
  fPartialBlocks := TList<TBlock>.Create;
...
begin
  ...
  begin
    ...
    begin
      fActiveBlock := fPartialBlocks.First;
      fPartialBlocks.Delete(0);
...
begin
  ...
  begin
    ...
    begin
      ...
      // if a block is empty, it's either going to be culled or recycled,
      // so it cannot be in the partial block list
      fPartialBlocks.Remove(block);
